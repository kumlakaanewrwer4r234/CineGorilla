...
final class HistoryView: UIView {
    ...
    private(set) var collectionView: UICollectionView = {
        ...
        collection.register(UsedTicketCell.self, forCellWithReuseIdentifier: "UsedTicketCell")
    ...
    private func setupSubviews() {
        [background, backButton, collectionView, pageControl].forEach {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            collectionView.heightAnchor.constraint(equalToConstant: 469),
